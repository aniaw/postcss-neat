...
var showGrid = function showGrid(columns, containerColumns, location, direction) {
  var options = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : _variablesEs2.default;
  var media = arguments[5];

  columns = columns || (media ? options[media].neatElementColumns : options[_mediaTypes2.default.Desktop].neatElementColumns);
  ...
  location = location || (media ? options[media].debugGridLocation : options[_mediaTypes2.default.Desktop].debugGridLocation);
  direction = direction || (media ? options[media].neatDefaultDirection : options[_mediaTypes2.default.Desktop].neatDefaultDirection);

  var neatColumnWidth = media ? options[media].neatColumnWidth : options[_mediaTypes2.default.Desktop].neatColumnWidth;
  var neatGutterWidth = media ? options[media].neatGutterWidth : options[_mediaTypes2.default.Desktop].neatGutterWidth;
  var debugGridColor = media ? options[media].debugGridColor : options[_mediaTypes2.default.Desktop].debugGridColor;

  var columnsCount = +(containerColumns / columns);
  var directions = _functionsEs2.default.getDirection(direction);
  var columnWidth = _functionsEs2.default.flexWidth(columns, containerColumns, neatColumnWidth, neatGutterWidth);
  var columnGutter = _functionsEs2.default.flexGutter(containerColumns, neatColumnWidth, neatGutterWidth);
  ...
  var gradient = generateArray(columnsCount).reduce(function (memo, idx) {
    ...
    memo.push(debugGridColor + ' ' + _functionsEs2.default.percentage(startColor) + ', ' + debugGridColor + ' ' + _functionsEs2.default.percentage(endColor));
