...
var _mediaTypesEs = require('../core/mediaTypes.es6.js');

var _mediaTypesEs2 = _interopRequireDefault(_mediaTypesEs);
...
var omega = function omega(query, direction) {
  var options = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : _variablesEs2.default;
  var media = arguments[3];

  direction = direction || (media ? options[media].neatDefaultDirection : options[_mediaTypesEs2.default.Desktop].neatDefaultDirection);
